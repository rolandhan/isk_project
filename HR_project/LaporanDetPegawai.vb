...
Public Class LaporanDetPegawai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_project.LaporanDetPegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDetPegawai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDetPegawai = New LaporanDetPegawai()
        rpt.Site = Me.Site
        Return rpt
    End Function
