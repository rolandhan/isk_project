...
Public Class LapDaftarCuti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_project.LapDaftarCuti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapDaftarCuti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapDaftarCuti = New LapDaftarCuti()
        rpt.Site = Me.Site
        Return rpt
    End Function
