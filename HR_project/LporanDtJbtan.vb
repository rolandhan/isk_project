...
Public Class LporanDtJbtan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_project.LporanDtJbtan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLporanDtJbtan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LporanDtJbtan = New LporanDtJbtan()
        rpt.Site = Me.Site
        Return rpt
    End Function
