...
Public Class LaporanKecKerja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_project.LaporanKecKerja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanKecKerja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanKecKerja = New LaporanKecKerja()
        rpt.Site = Me.Site
        Return rpt
    End Function
